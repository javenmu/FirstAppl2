        ...
        if(convertView == null){
            switch (type){
                case TYPE_APP:
                    ...
                    convertView = LayoutInflater.from(mContext).inflate(R.layout.listview_one, parent, false);
                    holder1.img_aicon = (ImageView) convertView.findViewById(R.id.img_aicon);
                    holder1.txt_aname = (TextView) convertView.findViewById(R.id.txt_aname);
                    convertView.setTag(R.id.Tag_APP,holder1);
                    break;
                case TYPE_BOOK:
                    holder2 = new ViewHolder2();
                    convertView = LayoutInflater.from(mContext).inflate(R.layout.listview_two, parent, false);
